<a class="svg" href="<?php echo esc_url(home_url('/')); ?>/">
	...
	<?php } else { ?>
		...
		<?php } else { ?>
			<object title="Justin Chick is a freelance WordPress developer in St. Louis MO" type="image/svg+xml" data="<?php echo get_template_directory_uri() . '/assets/img/jaechick-logo-404.svg' ?>" class="logo"></object>
			<?php } ?>
	<?php } ?>
</a>